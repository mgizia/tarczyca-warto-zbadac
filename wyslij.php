...
?>
    ...
    {
        $conn = new mysqli('mysql.cba.pl', 'login'/*tu login*/, 'haslo' /*tu haslo*/, 'tarczyca_warto_zbadac');
        ...
        //$sql = "ALTER TABLE ankietyzacja ADD FOREIGN KEY (id_objawu) REFERENCES objawy_ankietowanego(id_objawow) ";


        //$sql = "ALTER TABLE ankietyzacja ADD FOREIGN KEY (id_dodatkowych_chorob) REFERENCES dodatkowe_choroby(id_dodatkowe_choroby) ";
        ...
        if ($conn->query($sql) === TRUE) {
            ...
            //echo "New record created successfully"; // to mozna calkiem potem usunąć
        } else {
            echo "Error: " . $sql . "<br>" . $conn->error;
        }

        //$sql = "INSERT INTO ankietyzacja(plec, wiek, srodowisko_zycia, wojewodztwo, czy_aktywnosc_fizyczna, czy_dobra_dieta, ile_snu, czy_zdiagnozowano, czy_w_rodzinie, jaka_choroba) VALUES ('".$_POST['plec']."','".$_POST['wiek']."','".$_POST['gdzie']."','".$_POST['wojewodztwo']."','".$_POST['aktywnosc_fizyczna']."','".$_POST['prawidlowa_dieta']."','".$_POST['sen']."','".$_POST['zdiagnozowano']."','".$_POST['wystepujewrodzinie']."','".$_POST['choroba']."')";


        //$sql = "INSERT INTO dodatkowe_choroby(depresja, nadcisnienie, otylosc, cukrzyca, reumatoidalne_zapalenie_stawow, celiakia, inna ) VALUES ('".$_POST['depresja']."','".$_POST['nadcisnienie']."','".$_POST['otylosc']."','".$_POST['cukrzyca']."','".$_POST['reumatoidalne_zapalenie']."','".$_POST['celiakia']."','".$_POST['innachoroba']."')";


        //$sql = "INSERT INTO objawy_ankietowanego( wzrost_masy_ciala, znaczne_oslabienie, sennosc, uczucie_chlodu, obrzeki_podskorne, zaparcia, sucha_skora, zmeczenie, zaburzenia_pamieci, blada_skora, uczucie_goraca, potliwosc, utrata_masy_ciala, przyspieszenie_tetna, kolatanie_serca, powiekszenie_obwodu_szyi, niepokoj, drzenie_rak, bezsennosc, biegunki, zaburzenia_miesiaczkowania, problemy_z_zajsciem_w_ciaze ) VALUES('".$_POST['o1']."','".$_POST['o2']."','".$_POST['o3']."','".$_POST['o4']."','".$_POST['o5']."','".$_POST['o6']."','".$_POST['o7']."','".$_POST['o8']."','".$_POST['o9']."','".$_POST['o10']."','".$_POST['o11']."','".$_POST['o12']."','".$_POST['o13']."','".$_POST['o14']."','".$_POST['o15']."','".$_POST['o16']."','".$_POST['o17']."','".$_POST['o18']."','".$_POST['o19']."','".$_POST['o20']."','".$_POST['o21']."','".$_POST['o22']."')";
